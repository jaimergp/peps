...
Instead, we suggest that versioned distributions maintain a separate mapping per-release
(see the proposed mapping naming schemes). Non-versioned ecosystems should strive to keep
