...
- Some solutions only focused on Linux distributions or Unix systems, like Repology_ or pkgs.org.
- Other services like Libraries.io were password protected.
- Other providers like ecosyste.ms were only available via APIs.
- PURLDb only focused on collecting concrete PURLs (which identify specific package artifacts),
...
- Provides mappings between source PURLs and their repackaged counterparts.
