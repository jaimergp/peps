...
.. note::
  ...
  This naming rule implies that mapping maintainers can and should version
  their mappings, especially if package names are prone to changing (e.g.
  packages that encode their SONAME in Linux distributions).
